      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          <div>
            ...
            <p className="text-primary-foreground/80 text-sm leading-relaxed mb-6">
              Prémium szállások Newquay legszebb helyszínein. 
              Tedd felejthetetlen nyaralásodat velünk!
            </p>
          ...
          <div>
            <h4 className="font-display font-semibold text-lg mb-4">Gyors linkek</h4>
          ...
          <div>
            <h4 className="font-display font-semibold text-lg mb-4">Szállások</h4>
            <ul className="space-y-3">
              <li>
                <a href="#accommodations" className="text-primary-foreground/80 hover:text-sunset transition-colors text-sm">
                  Tengerparti Cottage
          ...
          <div>
            <h4 className="font-display font-semibold text-lg mb-4">Kapcsolat</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-primary-foreground/10 mt-12 pt-8 text-center">
          <p className="text-primary-foreground/60 text-sm">
            © {new Date().getFullYear()} NewquayStays. Minden jog fenntartva.
          </p>
        </div>
      </div>
    </footer>
